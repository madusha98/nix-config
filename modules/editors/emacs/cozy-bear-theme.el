...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((,class (:bold t :foreground ,builtin, :height 1.3))))
   `(org-level-2 ((,class (:bold t :foreground ,str))))
   `(org-level-3 ((,class (:bold t :foreground ,var ))))
   `(org-level-4 ((,class (:bold t :foreground ,func ))))
   `(org-level-5 ((,class (:bold t :foreground ,const ))))
   `(org-level-6 ((,class (:bold t :foreground ,keyword ))))
   `(org-level-7 ((,class (:bold t :foreground ,builtin))))
   `(org-level-8 ((,class (:bold t :foreground ,str))))
...
(provide-theme 'cozy-bear)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; cozy-bear-theme.el ends here
